    ...
    for tile, file_name, tile_id in tiles:
        ...
        if args.save or args.show:
            ...
            if args.mask_comparison:
                mask_path = args.mask_source + args.source.split("/")[-1]
                dim_x = tile_id % 2
                dim_y = tile_id // 2
                res_x = args.input_width
                res_y = args.input_height
                mask_img = np.load(mask_path)[dim_y*res_y:(dim_y+1)*res_y, dim_x*res_x:(dim_x+1)*res_x, :]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_width', '--input_w', type=int, default=512)
    parser.add_argument('--input_height', '--input_h', type=int, default=512)
    ...
    parser.add_argument('--mask_source', type=str, default='data/datasets/sentinel/masks/', help='path to dataset masks/labels')
